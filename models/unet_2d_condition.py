...
# This version can input the main scale to modulate
    ...
    def forward(
        ...
        if is_controlnet:
            ...
            for down_block_res_sample, down_block_additional_residual in zip(
                ...
                down_block_res_sample = main_scale * down_block_res_sample + down_block_additional_residual
        ...
        if is_controlnet:
            sample = main_scale*sample + mid_block_additional_residual
