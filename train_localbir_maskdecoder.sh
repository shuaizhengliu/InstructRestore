...
accelerate launch train_controlnetsd21_localbir_maskdecoder.py \
 --pretrained_model_name_or_path=$MODEL_DIR \
 --output_dir=$OUTPUT_DIR \
 --train_dataset_module='LocalBIRDataset'\
 --train_dataset_type='BIR_UniDeg2Clean_mainprompt_controlprompt_mask'\
 --test_dataset_module='LocalBIRDataset'\
 --test_dataset_type='Val_image'\
 --train_datafolder='Training_data/normal path'\
 ...
 --learning_rate=5e-5\
 --train_batch_size=32\
 --proportion_main_empty_prompts=0.2\
 --proportion_control_empty_prompts=0.2\
